...
if __name__ == "__main__":
    ...
    gd_instance = gd.GRID2DEMAND(input_dir, use_zone_id=True)
    ...
    zone_dict = gd_instance.net2zone(
        node_dict, num_x_blocks=10, num_y_blocks=10)
    ...
    df_agent = gd_instance.gen_agent_based_demand(
        node_prod_attr, zone_prod_attr, df_demand=gd.df_demand)

    # You can also view and edit the package setting by using gd.pkg_settings
    print(gd_instance.pkg_settings)
    ...
    gd_instance.save_node_within_zone
