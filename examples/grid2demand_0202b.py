...
def GetPoiTripRate(trip_rate_folder=None,
    ...
    print('\nTotal number of poi nodes with unmatched production rates is:', g_number_of_unmatched_poi_production_rate)
    print('Total number of poi nodes with unmatched attraction rates is:', g_number_of_unmatched_poi_attraction_rate)
    logger.info('Trip purpose used for grid2demand is: \n' + 'Purpose ' + str(g_trip_purpose))
    logger.info('Total number of poi nodes with unmatched production rate is: \n' + str(
        g_number_of_unmatched_poi_production_rate))
    logger.info('Total number of poi nodes with unmatched attraction rate is: \n' + str(
